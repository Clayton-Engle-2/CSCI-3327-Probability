...
public class ConditionalProb extends Task implements Runnable{
	...
	public ConditionalProb(double number1, double number2, Pipe<ShareData> pipe) {
	...
	public void run() {
		...
		try {
			probability = stat.probAgivenB(num1, num2);
		} catch (Exception e1) {
			e1.printStackTrace();
		}
